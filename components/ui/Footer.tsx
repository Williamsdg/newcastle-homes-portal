      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:5551234567" className="text-white/70 hover:text-accent-light transition-colors">
                  (555) 123-4567
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@demobuilders.com" className="text-white/70 hover:text-accent-light transition-colors">
                  info@demobuilders.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            &copy; {new Date().getFullYear()} Crestview Homes. All rights reserved.
          </p>
