...
const recentProperties = [
  { id: '1', address: '142 Barimore Lane', community: 'Barimore', price: '$489,900', status: 'AVAILABLE', bedrooms: 4, sqft: 2650 },
  { id: '2', address: '78 Falls Creek Dr', community: 'The Falls', price: '$524,900', status: 'PENDING', bedrooms: 4, sqft: 2890 },
  { id: '3', address: '215 Grand River Way', community: 'Grand River', price: '$399,900', status: 'AVAILABLE', bedrooms: 3, sqft: 2150 },
  { id: '4', address: '89 Heritage Pine Ct', community: 'Heritage Pines', price: '$459,900', status: 'SOLD', bedrooms: 4, sqft: 2480 },
]

const recentInquiries = [
  { id: '1', name: 'Sarah Mitchell', email: 'sarah.m@email.com', property: '142 Barimore Lane', type: 'Tour Request', time: '2 hours ago', priority: 'HIGH' },
  ...
  { id: '3', name: 'Emily & David Chen', email: 'chen.family@email.com', property: '78 Falls Creek Dr', type: 'Tour Request', time: '1 day ago', priority: 'HIGH' },
]

const upcomingTours = [
  { id: '1', buyer: 'The Martinez Family', property: '215 Grand River Way', date: 'Today', time: '2:00 PM' },
  { id: '2', buyer: 'Robert Johnson', property: '142 Barimore Lane', date: 'Tomorrow', time: '10:00 AM' },
  { id: '3', buyer: 'Amanda & Chris Lee', property: '89 Heritage Pine Ct', date: 'Jan 29', time: '3:30 PM' },
]
...
export default function DashboardPage() {
  ...
  const priorityColors: Record<string, string> = {
    ...
    MEDIUM: 'bg-newcastle-100 text-newcastle-700',
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        <div className="bg-white p-5 rounded-xl shadow-soft">
          <div className="flex items-center justify-between mb-3">
            <div className="w-10 h-10 bg-newcastle-100 rounded-lg flex items-center justify-center">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-soft">
          <div className="p-6 border-b border-slate flex justify-between items-center">
            <h2 className="text-lg font-heading font-semibold text-charcoal">Recent Properties</h2>
            <Link href="/dashboard/projects" className="text-newcastle hover:text-accent text-sm font-medium flex items-center gap-1">
              View All
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="divide-y divide-slate">
            {recentProperties.map((property) => (
              <Link
                ...
                className="block p-6 hover:bg-slate-light transition-colors"
              >
                <div className="flex items-center justify-between">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-soft">
              ...
              {upcomingTours.map((tour) => (
                <div key={tour.id} className="p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-newcastle-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-newcastle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-accent">{tour.date}</p>
            ...
            <div className="p-4 border-t border-slate">
              <button className="w-full text-center text-sm text-newcastle hover:text-accent font-medium">
                View All Tours →
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-soft">
            ...
            <div className="p-4 border-t border-slate">
              <Link href="/dashboard/messages" className="block w-full text-center text-sm text-newcastle hover:text-accent font-medium">
                View All Inquiries →
              </Link>
            </div>
          </div>
      ...
      <div className="mt-8 bg-white rounded-xl shadow-soft p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <select className="px-3 py-2 bg-slate rounded-lg text-sm text-charcoal border-0 focus:ring-2 focus:ring-newcastle/20">
            <option>Last 30 days</option>
            <option>Last 90 days</option>
            <option>This year</option>
          </select>
        </div>
        <div className="h-64 flex items-center justify-center bg-slate-light rounded-lg">
