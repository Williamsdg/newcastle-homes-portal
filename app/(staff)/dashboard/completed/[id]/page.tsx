...
const completedProperties: Record<string, {
  ...
  '1': {
    ...
    projectManager: { name: 'Carlos Hernandez', phone: '(205) 555-1003', email: 'carlos@demobuilders.com' },
    buildersAgent: { name: 'Sarah Mitchell', phone: '(205) 555-2001', email: 'sarah@demobuilders.com' },
  ...
  '2': {
    ...
    projectManager: { name: 'Mike Rodriguez', phone: '(205) 555-1001', email: 'mike@demobuilders.com' },
    buildersAgent: { name: 'John Davis', phone: '(205) 555-2002', email: 'john@demobuilders.com' },
    buyersAgent: null,
    buyer: null,
    closingDate: null,
  },
  '3': {
    ...
    projectManager: { name: 'James Wilson', phone: '(205) 555-1002', email: 'james@demobuilders.com' },
    buildersAgent: { name: 'Sarah Mitchell', phone: '(205) 555-2001', email: 'sarah@demobuilders.com' },
  ...
  '4': {
    ...
    projectManager: { name: 'Tom Bradley', phone: '(205) 555-1004', email: 'tom@demobuilders.com' },
    buildersAgent: { name: 'John Davis', phone: '(205) 555-2002', email: 'john@demobuilders.com' },
...
const allContractors = [
  { phase: '1. Pre-Construction', company: 'Demo Design Group', role: 'Architect / Residential Designer', contact: 'David Chen', phone: '(205) 555-5001', rating: 5, review: 'Excellent design work, delivered on time with great attention to detail.' },
  ...
  { phase: '3. Foundation & Structure', company: 'Demo Concrete & Foundation', role: 'Concrete Contractor', contact: 'Miguel Rodriguez', phone: '(205) 555-5020', rating: 5, review: 'Outstanding concrete work, level foundation, no issues.' },
  ...
  { phase: '3. Foundation & Structure', company: 'Demo Framing Co.', role: 'Framing Contractor', contact: 'James Wilson', phone: '(205) 555-5022', rating: 5, review: 'Excellent framing, square and true. Great crew.' },
  ...
  { phase: '4. Mechanical Rough-Ins', company: 'Demo Plumbing Services', role: 'Plumber', contact: 'Derek Thompson', phone: '(205) 555-5030', rating: 5, review: 'Clean pipe work, passed inspection first time.' },
  { phase: '4. Mechanical Rough-Ins', company: 'Demo Electric Pro', role: 'Electrician', contact: 'Carlos Hernandez', phone: '(205) 555-5031', rating: 4, review: 'Good electrical rough-in, one minor code correction needed.' },
  { phase: '4. Mechanical Rough-Ins', company: 'Demo HVAC Solutions', role: 'HVAC', contact: 'Tom Bradley', phone: '(205) 555-5032', rating: 5, review: 'System installed properly, excellent airflow balance.' },
  ...
  { phase: '5. Building Envelope', company: 'Demo Roofing Experts', role: 'Roofing Contractor', contact: 'David Mitchell', phone: '(205) 555-5040', rating: 5, review: 'Excellent roofing job, very clean and professional.' },
  ...
  { phase: '6. Interior Finishes', company: 'Demo Drywall Inc.', role: 'Drywall Contractor', contact: 'Robert Chen', phone: '(205) 555-5050', rating: 5, review: 'Smooth finish, no visible seams, excellent work.' },
  { phase: '6. Interior Finishes', company: 'Demo Paint & Finishes', role: 'Painter', contact: 'Jennifer Adams', phone: '(205) 555-5051', rating: 4, review: 'Good paint job, one touch-up needed.' },
  ...
  { phase: '7. Final Mechanical', company: 'Demo Plumbing Services', role: 'Plumber (Return)', contact: 'Derek Thompson', phone: '(205) 555-5030', rating: 5, review: 'All fixtures installed perfectly.' },
  { phase: '7. Final Mechanical', company: 'Demo Electric Pro', role: 'Electrician (Return)', contact: 'Carlos Hernandez', phone: '(205) 555-5031', rating: 5, review: 'All fixtures and switches work perfectly.' },
  { phase: '7. Final Mechanical', company: 'Demo HVAC Solutions', role: 'HVAC (Return)', contact: 'Tom Bradley', phone: '(205) 555-5032', rating: 5, review: 'System running smoothly, all registers balanced.' },
  ...
  { phase: '8. Exterior & Landscape', company: 'Demo Concrete & Foundation', role: 'Flatwork (Driveway/Patios)', contact: 'Miguel Rodriguez', phone: '(205) 555-5020', rating: 5, review: 'Beautiful driveway and patio work.' },
  ...
  { phase: '9. Final Inspections', company: 'Crestview Homes', role: 'Punch List Review', contact: 'Project Manager', phone: '(205) 555-1000', rating: 5, review: 'Thorough punch list completion.' },
]
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-soft overflow-hidden">
            <div className="p-5 border-b border-slate bg-amber-500 text-white">
              <h2 className="text-lg font-heading font-semibold">Crestview Equipment Used</h2>
