...
const subcontractors = [
  {
    id: '1',
    company: 'Demo Concrete & Foundation',
    contact: 'Miguel Rodriguez',
    email: 'miguel@democonc.com',
    phone: '(205) 555-1001',
    trade: 'Foundation',
    status: 'ACTIVE',
    rating: 4.8,
  ...
  {
    id: '2',
    company: 'Demo Framing Co.',
    contact: 'James Wilson',
    email: 'james@demoframing.com',
    phone: '(205) 555-1002',
    trade: 'Framing',
    status: 'ACTIVE',
    rating: 4.9,
  ...
  {
    id: '3',
    company: 'Demo Electric Pro',
    contact: 'Carlos Hernandez',
    email: 'carlos@demoelectric.com',
    phone: '(205) 555-1003',
    trade: 'Electrical',
    status: 'ACTIVE',
    rating: 4.7,
  ...
  {
    id: '4',
    company: 'Demo Plumbing Services',
    contact: 'Derek Thompson',
    email: 'derek@demoplumb.com',
    phone: '(205) 555-1004',
    trade: 'Plumbing',
    status: 'ACTIVE',
    rating: 4.6,
  ...
  {
    id: '5',
    company: 'Demo HVAC Solutions',
    contact: 'Tom Bradley',
    email: 'tom@demohvac.com',
    phone: '(205) 555-1005',
    trade: 'HVAC',
    status: 'ACTIVE',
    rating: 4.8,
  ...
  {
    id: '6',
    company: 'Demo Roofing Experts',
    contact: 'David Mitchell',
    email: 'david@demoroofing.com',
    phone: '(205) 555-1006',
    trade: 'Roofing',
    status: 'ACTIVE',
    rating: 4.5,
  ...
  {
    id: '7',
    company: 'Demo Drywall Inc.',
    contact: 'Robert Chen',
    email: 'robert@demodrywall.com',
    phone: '(205) 555-1007',
    trade: 'Drywall',
    status: 'ACTIVE',
    rating: 4.7,
  ...
  {
    id: '8',
    company: 'Demo Paint & Finishes',
    contact: 'Jennifer Adams',
    email: 'jennifer@demopaint.com',
    phone: '(205) 555-1008',
    trade: 'Painting',
    status: 'INACTIVE',
    rating: 4.3,
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/dashboard/subcontractors/new" className="btn-primary py-2 px-4 text-sm flex items-center gap-2">
