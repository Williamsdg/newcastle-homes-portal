...
const propertyData: Record<string, {
  ...
  '4': {
    ...
    progress: 8,
    status: 'ON_TRACK',
    projectManager: { name: 'Tom Bradley', phone: '(205) 555-1004', email: 'tbradley@demobuilders.com' },
    buildersAgent: { name: 'John Davis', phone: '(205) 555-2002', email: 'john@demobuilders.com' },
    buyersAgent: null,
    buyer: null,
  },
...
const constructionPhases = [
  {
    ...
    color: 'bg-slate-500',
    contractors: [
      { role: 'Architect / Residential Designer', company: 'Demo Design Group', contact: 'David Chen', phone: '(205) 555-5001', status: 'COMPLETED', required: true, rating: 5, review: 'Excellent design work, delivered on time with great attention to detail.' },
  ...
  },
  {
    ...
    color: 'bg-orange-500',
    contractors: [
      { role: 'Concrete Contractor', company: 'Demo Concrete & Foundation', contact: 'Miguel Rodriguez', phone: '(205) 555-5020', status: 'COMPLETED', required: true, rating: 5, review: 'Outstanding concrete work, level foundation, no issues.' },
      ...
      { role: 'Framing Contractor', company: 'Demo Framing Co.', contact: 'James Wilson', phone: '(205) 555-5022', status: 'IN_PROGRESS', required: true, rating: 0, review: '' },
  ...
  },
  {
    ...
    color: 'bg-yellow-500',
    contractors: [
      { role: 'Plumber', company: 'Demo Plumbing Services', contact: 'Derek Thompson', phone: '(205) 555-5030', status: 'COMPLETED', required: true, rating: 5, review: 'Clean pipe work, passed inspection first time.' },
      { role: 'Electrician', company: 'Demo Electric Pro', contact: 'Carlos Hernandez', phone: '(205) 555-5031', status: 'COMPLETED', required: true, rating: 4, review: 'Good electrical rough-in, one minor code correction needed.' },
      { role: 'HVAC Contractor', company: 'Demo HVAC Solutions', contact: 'Tom Bradley', phone: '(205) 555-5032', status: 'IN_PROGRESS', required: true, rating: 0, review: '' },
  ...
  },
  {
    ...
    color: 'bg-lime-500',
    contractors: [
      { role: 'Roofing Contractor', company: 'Demo Roofing Experts', contact: 'David Mitchell', phone: '(205) 555-5040', status: 'COMPLETED', required: true, rating: 5, review: 'Excellent roofing job, very clean and professional.' },
  ...
  },
  {
    ...
    color: 'bg-green-500',
    contractors: [
      { role: 'Drywall Contractor', company: 'Demo Drywall Inc.', contact: 'Robert Chen', phone: '(205) 555-5050', status: 'COMPLETED', required: true, rating: 5, review: 'Smooth finish, no visible seams, excellent work.' },
      { role: 'Painter', company: 'Demo Paint & Finishes', contact: 'Jennifer Adams', phone: '(205) 555-5051', status: 'IN_PROGRESS', required: true, rating: 0, review: '' },
  ...
  },
  {
    ...
    color: 'bg-teal-500',
    contractors: [
      { role: 'Plumber (Return Visit)', company: 'Demo Plumbing Services', contact: 'Derek Thompson', phone: '(205) 555-5030', status: 'PENDING', required: true, rating: 0, review: '' },
      { role: 'Electrician (Return Visit)', company: 'Demo Electric Pro', contact: 'Carlos Hernandez', phone: '(205) 555-5031', status: 'PENDING', required: true, rating: 0, review: '' },
      { role: 'HVAC (Return Visit)', company: 'Demo HVAC Solutions', contact: 'Tom Bradley', phone: '(205) 555-5032', status: 'PENDING', required: true, rating: 0, review: '' },
  ...
  },
  {
    ...
    color: 'bg-cyan-500',
    contractors: [
      { role: 'Concrete / Flatwork (Driveway, Sidewalks, Patios)', company: 'Demo Concrete & Foundation', contact: 'Miguel Rodriguez', phone: '(205) 555-5020', status: 'PENDING', required: true, rating: 0, review: '' },
  ...
  },
  {
    ...
    contractors: [
      ...
      { role: 'General Contractor Punch List', company: 'Crestview Homes', contact: 'Project Manager', phone: '(205) 555-1000', status: 'PENDING', required: true, rating: 0, review: '' },
    ],
    equipment: [],
    photos: 0,
  },
